# FastTerminal 0.1.8 [ALPHA-2026-07] — High-Performance True-Color Terminal Engine for Java

[![Status](https://img.shields.io/badge/status-0.1.8-brightgreen.svg)](https://github.com/andrestubbe/FastTerminal/releases/tag/0.1.8)
