# FastTerminal 0.1.10 [ALPHA-2026-07] — High-Performance True-Color Terminal Engine for Java

[![Status](https://img.shields.io/badge/status-0.1.10-brightgreen.svg)](https://github.com/andrestubbe/FastTerminal/releases/tag/0.1.10)
...
- **[COMPILE.md](docs/COMPILE.md)**: Native C++ DLL build instructions, JDK prerequisites, and compilation workflow.
