...
echo [INFO] Running Real-Time Differential Telemetry Benchmark...
java --enable-native-access=ALL-UNNAMED -cp "target/classes;target/dependency/*;../../target/fastterminal-0.1.0.jar" fastterminal.BenchmarkDemo
